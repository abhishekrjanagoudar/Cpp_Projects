...
void shopDbTests() {
  ...
  assertTrue(fabs(fd5.discountFor(0) - 0.05) < 1e-6, "Fixed Discount 5 failed");
  assertTrue(fabs(fd5.discountFor(10) - 0.05) < 1e-6, "Fixed Discount 5 failed");
  assertTrue(fabs(fd5.discountFor(100) - 0.05) < 1e-6, "Fixed Discount 5 failed");

  // Verify the 10% discount applies evenly across different quantities
  assertTrue(fabs(fd10.discountFor(0) - 0.10) < 1e-6, "Fixed Discount 10 failed");
  assertTrue(fabs(fd10.discountFor(10) - 0.10) < 1e-6, "Fixed Discount 10 failed");
  assertTrue(fabs(fd10.discountFor(100) - 0.10) < 1e-6, "Fixed Discount 10 failed");
  ...
  assertTrue(fabs(qd.discountFor(0) - 0) < 1e-6, "Quantity Discount for 0 Failed");
  assertTrue(fabs(qd.discountFor(9) - 0) < 1e-6, "Quantity Discount for 9 Failed");

  // Verify 5% discount triggers exactly at quantity 10
  assertTrue(fabs(qd.discountFor(10) - 0.05) < 1e-6, "Quantity Discount for 10 Failed");
  assertTrue(fabs(qd.discountFor(11) - 0.05) < 1e-6, "Quantity Discount for 11 Failed");
  assertTrue(fabs(qd.discountFor(49) - 0.05) < 1e-6, "Quantity Discount for 49 Failed");

  // Verify 10% discount triggers exactly at quantity 50
  assertTrue(fabs(qd.discountFor(50) - 0.10) < 1e-6, "Quantity Discount for 50 Failed");
  assertTrue(fabs(qd.discountFor(51) - 0.10) < 1e-6, "Quantity Discount for 51 Failed");
  assertTrue(fabs(qd.discountFor(99) - 0.10) < 1e-6, "Quantity Discount for 99 Failed");

  // Verify 15% discount triggers exactly at quantity 100
  assertTrue(fabs(qd.discountFor(100) - 0.15) < 1e-6, "Quantity Discount for 100 Failed");
  assertTrue(fabs(qd.discountFor(101) - 0.15) < 1e-6, "Quantity Discount for 101 Failed");
